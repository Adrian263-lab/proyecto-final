...
/**
 * Componente GestionLogo: permite al usuario actualizar su imagen de perfil (logo).
 * Gestiona la previsualización local, la subida vía FormData y la persistencia del estado global.
 */
export default function GestionLogo() {
  ...
  /**
   * Maneja el evento de selección de archivo y genera la URL de previsualización local.
   */
  ...
  /**
   * Envía la imagen al servidor y sincroniza el estado global de la aplicación.
   */
  const subirImagen = async () => {
    ...
    try {
      ...
      // Actualización de estado global y persistencia en LocalStorage
      ...
      <div className="text-center">
        ...
        {archivo && (
          <div className="mt-2 animate__animated animate__fadeIn">
            ...
            <button 
              onClick={() => { setArchivo(null); setPreview(user?.logo_url); }} 
