...
export default function DetalleAnimal() {
  ...
  const handleSubmitAdopcion = async (e) => {
    e.preventDefault();
    try {
      // Enviamos el objeto con los campos que Laravel requiere
      ...
      Swal.fire('Error', 'No se pudo enviar la solicitud. Revisa que todos los campos estén completos.', 'error');
    }
  };
  ...
  return (
    <div className="container mt-5 animate__animated animate__fadeIn">
              ...
              <div className="modal-body p-4">
                <form onSubmit={handleSubmitAdopcion}>
                  ...
                  <div className="mb-3">
                    ...
                    <textarea className="form-control rounded-4" onChange={(e) => setFormAdopcion({ ...formAdopcion, motivo: e.target.value })} required />
                  </div>
      ...
      {/* Contenido Principal (Exactamente igual que tu original) */}
