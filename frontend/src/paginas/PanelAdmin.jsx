...
/**
 * Componente PanelAdmin: Interfaz administrativa para la validación de nuevas protectoras.
 * Permite listar solicitudes pendientes y gestionar su aprobación o rechazo.
 */
const PanelAdmin = () => {
    const [pendientes, setPendientes] = useState([]);

    /**
     * Obtiene la lista de protectoras con estado 'pendiente' desde la API.
     */
    ...
    // --- ACCIONES DE GESTIÓN DE PROTECTORAS ---

    /**
     * Valida una protectora específica, cambiando su estado a activo.
     */
    ...
    /**
     * Elimina permanentemente una solicitud de protectora tras confirmación.
     */
    ...
    return (
        <div className="container mt-5 animate__animated animate__fadeIn">
            ...
            {/* TABLA: Protectoras pendientes de validación */}
